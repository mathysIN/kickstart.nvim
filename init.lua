...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  callback = function()
    -- Check if vim.hl is available (Neovim 0.8+)
    if vim.hl then
      vim.hl.on_yank()
    end
  end,
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><tab>', require('telescope.builtin').oldfiles)
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        ['<S-Tab>'] = { 'show', 'show_documentation', 'accept' },
        ['<C-e>'] = { 'hide', 'fallback' },
        ['<CR>'] = { 'accept', 'fallback' },
      ...
      completion = {
        autocomplete = true, -- Show completion automatically as you type
        documentation = {
          auto_show = true, -- Show documentation automatically
          auto_show_delay_ms = 0, -- Small delay before showing docs
        },
      },
      sources = {
  ...
  { -- Harpoon: fast file switching
    ...
    config = function()
      ...
      -- Toggle previous/next buffer in harpoon list
